...
export const usersAPI = {
    getUsersAPI(currentPage:number = 1, countUsersOfPage:number = 10, term: string = '', friend: null | boolean = null) {
        return instance.get<getUsersType>(`users?page=${currentPage}&count=${countUsersOfPage}&term=${term}` +
